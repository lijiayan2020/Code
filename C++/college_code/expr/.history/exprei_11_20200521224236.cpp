 ...
 * @LastEditTime: 2020-05-21 22:42:36
 */ 
//十一、继承与派生实验（4学时）
...
public:
    ...
    Teacher(string Tn,int Tid,string job_title,string class_n,int class_num ):Tname(Tn),Tid(Tid),job_title(job_title),class_n(class_n),class_num(class_num){} 
...
public:
    ...
    TA(string n,int id,string pro,string class_n,int class_num):Student(n,id,pro),Teacher("",0,"",class_n,class_num){}
    ~TA();
    void ShowInfo()
    {
