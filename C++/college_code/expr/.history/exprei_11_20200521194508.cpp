 ...
 * @LastEditTime: 2020-05-21 19:45:08
 */ 
//十一、继承与派生实验（4学时）
...
public:
    ...
    Teacher(string Tname,int Tid,string job_title,string class_n,int class_num )
	{
...
public:
    TA(string n,int id,string pro,string class_n,int class_num):Student(n,id,pro),Teacher(Tname,Tid,job_title,class_n,class_num){}
    ~TA();
    void ShowInfo()
    {
        cout << "name:" << name << endl;
