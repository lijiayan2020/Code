 ...
 * @LastEditTime: 2020-05-21 18:19:06
 */ 
//十一、继承与派生实验（4学时）
...
// 助教类
class TA:public Student private Teacher
{
private:
    int id;
    string name;
...
public:
    TA(string n,int id,string pro,string class_n,int class_nu):Student(n,id,pro),Teacher(n,id,jt,class_n,class_nu){}
    ~TA();
    void ShowInfo()
    {
        cout << "name:" << name << endl;
