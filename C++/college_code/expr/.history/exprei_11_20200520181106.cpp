 ...
 * @LastEditTime: 2020-05-20 18:11:06
 */ 
//十一、继承与派生实验（4学时）
...
public:
    TA(string n,int id,string pro,string class_n,int class_nu):name(n),id(id),profession(pro),class_n(class_n),class_num(class_nu){}
    ~TA();
    void ShowInfo()
    {
        cout << "name:" << name;
